...
#include<fcntl.h>
#include<termios.h>
int headX,headY,fruitX,fruitY,width=55,height=30,gameOver=0,direction=2,speeds=0.8i,size=0,score=0,speed=100000;
...
"╚═════╝ ╚═╝  ╚══╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝   ╚═════╝ ╚═╝  ╚═╝╚═╝     ╚═╝╚══════╝ @VCS\n");
 ...
 printf("\e[1;33mSᴄᴏʀᴇᴅ : %5d\t\t\e[1;37m",score);
}
